...
def _budget_runtime_updates(
    ...
    *,
    ...
    is_agentic = effective_route == "agentic_retrieval"
...
def _stage_timeout_seconds(
    ...
    *,
    ...
    if reserve_generate and state.get("route") == "agentic_retrieval":
...
async def generate_node(state: AgentState) -> dict[str, Any]:
    ...
    if state["route"] == "agentic_retrieval" and state.get("missing_aspects"):
        retrieval_context = (
            "coverage_warning:\n"
    ...
    if state["route"] == "direct_answer":
        ...
        updates["warning"] = _warning_for_state(confidence, True)
